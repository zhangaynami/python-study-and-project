...
def stock_jgdy_tj_em(date: str = "20220101") -> pd.DataFrame:
    ...
    # big_df.to_csv(r'D:/PYTHONSTUDY/pythonProject7/爬虫/机构调研1.csv',index=False,header=0,mode='a',encoding='ANSI')
    big_df.index = big_df.index + 1
    big_df.to_excel(r'D:/PYTHONSTUDY/pythonProject7/爬虫/机构调研1.xlsx')
    return big_df
...
def stock_jgdy_detail_em(date: str = "20220101") -> pd.DataFrame:
    ...
    big_df['公告日期'] = pd.to_datetime(big_df['公告日期']).dt.date
    big_df.to_csv(r'D:/PYTHONSTUDY/pythonProject7/爬虫/机构调研2.csv', index=False, header=0, mode='a', encoding='ANSI')
    return big_df


if __name__ == "__main__":
    stock_jgdy_tj_em_df = stock_jgdy_tj_em(date="20220901")
    print(stock_jgdy_tj_em_df)

    # stock_jgdy_detail_em_df = stock_jgdy_detail_em(date="20220901")
